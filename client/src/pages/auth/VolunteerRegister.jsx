  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gradient-to-br from-green-50 via-white to-blue-50">
      ...
      <motion.div
        ...
        className="absolute left-0 top-0 h-80 w-80 rounded-full bg-green-200 opacity-30 blur-3xl"
      />
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              disabled={loading}
              className="flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-500 py-4 font-bold text-white shadow-xl transition hover:shadow-2xl disabled:opacity-60"
            >
